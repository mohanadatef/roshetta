...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/admin/scientific_degree/index') }}"><i class="fa fa-permsissions"></i> {{ trans('lang.Scientific_Degree') }}</a></li>
            <li><a href="{{ url('/admin/scientific_degree/edit/'.$data['id']) }}"><i class="fa fa-permsission"></i>{{ trans('lang.Edit') }} : @if(isset($data['title'][Language_Locale()])) {{$data['title'][Language_Locale()]}} @endif   </a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                <form id="edit" action="{{url('admin/scientific_degree/update/'.$data['id'])}}" method="POST" >
                    {{csrf_field()}}
                    {{method_field('patch')}}
...
@section('script_style')
    {!! JsValidator::formRequest('App\Http\Requests\Core_Data\Scientific_Degree\EditRequest','#edit') !!}
@endsection