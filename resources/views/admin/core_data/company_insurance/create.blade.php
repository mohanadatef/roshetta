...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/admin/company_insurance/index') }}"><i class="fa fa-permsissions"></i>{{ trans('lang.Index') }}</a></li>
            <li><a href="{{ url('/admin/company_insurance/create') }}"><i class="fa fa-permsission"></i>{{ trans('lang.Create') }}</a>
            </li>
        </ol>
    </section>
    <section class="content">
        <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                <form id='create' action="{{url('admin/company_insurance/store')}}" method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}
...
@section('script_style')
    {!! JsValidator::formRequest('App\Http\Requests\Core_Data\Company_Insurance\CreateRequest','#create') !!}
@endsection