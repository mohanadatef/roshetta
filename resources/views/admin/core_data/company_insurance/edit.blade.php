...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/admin/company_insurance/index') }}"><i class="fa fa-permsissions"></i> {{ trans('lang.Company_Insurance') }}</a></li>
            <li><a href="{{ url('/admin/company_insurance/edit/'.$data['id']) }}"><i class="fa fa-permsission"></i>{{ trans('lang.Edit') }} : @if(isset($data['title'][Language_Locale()])) {{$data['title'][Language_Locale()]}} @endif   </a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                <form id="edit" action="{{url('admin/company_insurance/update/'.$data['id'])}}" method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}
                    {{method_field('patch')}}
                    ...
                    <div align="center">
                    <img src="{{url('public/images/company_insurance/'.$data['image'])}}" style="width: 50%;height: 50%">
...
@section('script_style')
    {!! JsValidator::formRequest('App\Http\Requests\Core_Data\Company_Insurance\EditRequest','#edit') !!}
@endsection