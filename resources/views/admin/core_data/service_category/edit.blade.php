...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/admin/service_category/index') }}"><i class="fa fa-permsissions"></i> {{ trans('lang.Service_Category') }}</a></li>
            <li><a href="{{ url('/admin/service_category/edit/'.$data['id']) }}"><i class="fa fa-permsission"></i>{{ trans('lang.Edit') }} : @if(isset($data['title'][Language_Locale()])) {{$data['title'][Language_Locale()]}} @endif   </a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                <form id="edit" action="{{url('admin/service_category/update/'.$data['id'])}}" method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}
                    {{method_field('patch')}}
                    ...
                    <div align="center">
                    <img src="{{url('public/images/service_category/'.$data['image'])}}" style="width: 50%;height: 50%">
...
@section('script_style')
    {!! JsValidator::formRequest('App\Http\Requests\Core_Data\Service_Category\EditRequest','#edit') !!}
@endsection