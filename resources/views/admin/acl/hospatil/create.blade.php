...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/admin/hospatil/create') }}"><i
    ...
    <section class="content">
        <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                <form id='create' action="{{url('admin/hospatil/store')}}" method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="row">
...
@section('script_style')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Acl\Hospatil\CreateRequest','#create') !!}
@endsection