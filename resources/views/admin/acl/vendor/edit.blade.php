...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/admin/vendor/edit/'.$data['id']) }}"><i class="fa fa-permsission"></i>{{ trans('lang.Edit') }} : {{Auth::user()->title}} </a></li>
    ...
    <section class="content">
        <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                <form id="edit" action="{{url('admin/vendor/update/'.$data['id'])}}" method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}
                    {{method_field('patch')}}
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <img src="{{url('public/images/user/vendor/'.$data['image_license'])}}" style="width: 50px;height: 50px">
                        ...
                        <div class="col-md-6">
                            <img src="{{url('public/images/user/vendor/'.$data['image_university'])}}" style="width: 50px;height: 50px">
...
@section('script_style')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Acl\Vendor\EditRequest','#edit') !!}
@endsection