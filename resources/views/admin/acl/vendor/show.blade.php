...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/admin/vendor/show/'.$data['id']) }}"><i
    ...
    <section class="content">
        <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                <form action="{{url('admin/vendor/change_status_request/'.$data['id'])}}" method="Get"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <img src="{{url('public/images/user/vendor/'.$data['image_license'])}}"
                                 style="width: 50px;height: 50px">
                        </div>
                        <div class="col-md-6">
                            <img src="{{url('public/images/user/vendor/'.$data['image_university'])}}"
                                 style="width: 50px;height: 50px">
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div align="center">
                            @if($data['status_request'] == 1)
                                ...
                                <a href="{{ url('/admin/vendor/index')}}"><i
                            ...
                            @elseif($data['status_request'] == 0)
                                ...
                                <a href="{{ url('/admin/vendor/index_request')}}"><i
                                            class="btn btn-primary ">{{ trans('lang.Back') }}</i></a>
                            @endif
                        </div>
                </form>
