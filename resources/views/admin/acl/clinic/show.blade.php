...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/admin/clinic/show/'.$data['id']) }}"><i
        ...
        <div class="box">
            ...
            <div class="box-body">
                <form action="{{url('admin/clinic/change_status_request/'.$data['id'])}}" method="Get"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <img src="{{url('public/images/user/clinic/'.$data['image_license'])}}"
                                 style="width: 50px;height: 50px">
                        </div>
                        <div class="col-md-6">
                            <img src="{{url('public/images/user/clinic/'.$data['image_university'])}}"
                                 style="width: 50px;height: 50px">
                        </div>
                    </div>
                    <div class="row">
