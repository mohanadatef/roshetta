...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/admin/clinic/index') }}"><i class="fa fa-Users"></i>{{ trans('lang.Index') }}</a></li>
        </ol>
    </section>
    <section class="content">
        <form id="status" method="get" action="{{ url('/admin/clinic/change_many_status')}}">
            <div class="box">
                <div class="box-header" align="right">
                    @if(count($datas) > 0)
                        @if(permission_show('clinic-many-status'))
                        ...
                        <div align="center" class="col-md-12 table-responsive">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    @if(permission_show('clinic-status'))
                                ...
                                @foreach($datas as $data)
                                    <tr>
                                        ...
                                        @if(permission_show('clinic-status'))
                                            <td align="center">
                                                @if($data->status ==1)
                                                    <a href="{{ url('/admin/clinic/change_status/'.$data->id)}}"><i
                                        ...
                                        @if(permission_show('clinic-status-request'))
                                            <td align="center">
                                                @if($data->clinic->status_request ==1)
                                                    <a href="{{ url('/admin/clinic/change_status_request/'.$data->clinic->id)}}"><i
                                                                class="btn btn-danger ace-icon fa fa-close">{{ trans('lang.An_active') }}</i></a>
                                                @elseif($data->clinic->status_request ==0)
                                                    <a href="{{ url('/admin/clinic/change_status_request/'.$data->clinic->id)}}"><i
                                                                class="btn btn-primary ace-icon fa fa-check-country"> {{ trans('lang.Active') }}</i></a>
                                                @endif
                                            </td>
                                        ...
                                        @if(permission_show('clinic-show-request'))
                                            <td align="center">
                                                <a href="{{ url('/admin/clinic/show_request/'.$data->clinic->id)}}"><i
