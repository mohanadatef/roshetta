                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has('status_home') ? ' has-error' : "" }}">
                                ...
                                <select id="status_home" class="form-control select2"
                                    ...
                                    <option value="1"> {{trans('lang.Open')}}</option>
                                    <option value="0"> {{trans('lang.Close')}}</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has('specialty_id ') ? ' has-error' : "" }}">
                                ...
                                <select id="specialty_id" class="form-control select2" data-placeholder="{{trans('lang.Message_Role')}}" name="specialty_id">
                        ...
                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has('scientific_degree_id ') ? ' has-error' : "" }}">
                                ...
                                <select id="scientific_degree" class="form-control select2" data-placeholder="{{trans('lang.Message_Role')}}" name="scientific_degree_id">
                                    <option value="0" selected>{{trans('lang.Select')}}</option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has('sub_specialty') ? ' has-error' : "" }}">
                                ...
                                <select id="sub_specialty_id" multiple='multiple ' class="form-control"  name="sub_specialty[]">
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has('image_license') ? ' has-error' : "" }}">
                                <table class="table">
                                    <tr>
                                        <td width="40%" align="right"><label>{{ trans('lang.Message_Image_License') }}</label></td>
                        ...
                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has('image_university') ? ' has-error' : "" }}">
                                <table class="table">
                                    <tr>
                                        <td width="40%" align="right"><label>{{ trans('lang.Message_Image_university') }}</label></td>
