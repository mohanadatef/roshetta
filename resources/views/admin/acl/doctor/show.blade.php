...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/admin/doctor/show/'.$data['id']) }}"><i
    ...
    <section class="content">
        <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                <form action="{{url('admin/doctor/change_status_request/'.$data['id'])}}" method="Get"
                            ...
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('title_doctor['.$lang->code.']') ? ' has-error' : "" }}">
                                    {{ $lang->title .' '. trans('lang.Title_Doctor') }} : <input type="text"
                                                                                                 disabled="disabled"
                                                                                                 @if(isset($data['title_doctor'][$lang->code])) value="{{$data['title_doctor'][$lang->code]}}"
                                                                                                 @endif
                                                                                                 class="form-control"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <img src="{{url('public/images/user/doctor/'.$data['image_license'])}}"
                                 style="width: 50px;height: 50px">
                        </div>
                        <div class="col-md-6">
                            <img src="{{url('public/images/user/doctor/'.$data['image_university'])}}"
                                 style="width: 50px;height: 50px">
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div align="center">
                            @if($data['status_request'] == 1)
                                ...
                                <a href="{{ url('/admin/doctor/index')}}"><i
                            ...
                            @elseif($data['status_request'] == 0)
                                ...
                                <a href="{{ url('/admin/doctor/index_request')}}"><i
                                            class="btn btn-primary ">{{ trans('lang.Back') }}</i></a>
                            @endif
                        </div>
                </form>
