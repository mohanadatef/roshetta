...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('hospital'.$data['id']) }}"><i class="fa fa-permsission"></i>{{ trans('lang.Edit') }} : {{Auth::user()->hospital->title}} </a></li>
    ...
    <section class="content">
        <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                <form id="edit" action="{{url('admin/hospital/update/'.$data['id'])}}" method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}
                    {{method_field('patch')}}
                    <div class="row">
