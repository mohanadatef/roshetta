...
@section('content')
    ...
    <section class="content">
        <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                <form id='create' action="{{url('admin/hospital/store')}}" method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="row">
...
@section('script_style')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Acl\Hospital\CreateRequest','#create') !!}
@endsection