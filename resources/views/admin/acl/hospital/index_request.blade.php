...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/admin/hospital/index') }}"><i class="fa fa-Users"></i>{{ trans('lang.Index') }}</a>
            </li>
        </ol>
    </section>
                    ...
                    <div align="center" class="col-md-12 table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                @if(permission_show('hospital-status-request'))
                                    <th align="center">{{ trans('lang.Status_Request') }}</th>
                                @endif
                                @if(permission_show('hospital-show-request'))
                            ...
                            @foreach($datas as $data)
                                <tr>
                                    <td align="center">
                                        @if(permission_show('hospital-many-status'))
                                    ...
                                    <td class="center">
                                        <img src="{{ asset('public/images/hospital').($data->image ? '/'.$data->image : '/profile_user.jpg') }}"
                                             style="width:100px;height: 100px">
                                    </td>
                                    @if(permission_show('hospital-status-request'))
                                        <td align="center">
                                            @if($data->status_request ==1)
                                                <a href="{{ url('/admin/hospital/change_status_request/'.$data->id)}}"><i
                                    ...
                                    @if(permission_show('hospital-show-request'))
                                        <td align="center">
                                            <a href="{{ url('/admin/hospital/show_request/'.$data->id)}}"><i
...
@section('script_style')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Acl\Hospital\StatusEditRequest','#status') !!}
@endsection