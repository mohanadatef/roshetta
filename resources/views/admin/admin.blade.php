        ...
        <div class="row">
            ...
            @if(permission_show('patient-index'))
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-yellow">
                        ...
                        <a href="{{ url('/admin/patient/index') }}" class="small-box-footer">{{trans('lang.Index')}} <i
            ...
            @if(permission_show('doctor-index'))
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-blue">
                        ...
                        <a href="{{ url('/admin/doctor/index') }}" class="small-box-footer">{{trans('lang.Index')}} <i
                                    class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            @endif
            @if(permission_show('doctor-list-information'))
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-blue">
                        <div class="inner">
                            <h3>{{auth::user()->doctor->count_view}}</h3>
                ...
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-blue">
                        <div class="inner">
                            ...
                            <p>{{trans('lang.Clinic')}}</p>
                        </div>
                        <div class="icon">
                            <i class="ion ion-person"></i>
                        </div>
                        <a href="{{ url('/admin/clinic/index') }}" class="small-box-footer">{{trans('lang.Index')}} <i
                                    class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            @endif
