...
class MedicineCategoryRepository implements MedicineCategoryInterface
{
    ...
    public function Get_One_Data_Translation($id)
    {
        ...
        return $medicine_category ? array_merge($this->medicine_category->find($id)->toarray(), $medicine_category) : $this->medicine_category->find($id);
    }
    ...
    public function Update_Status_One_Data($id)
    {
        ...
        $medicine_category->status == 1 ? $medicine_category->status = '0' : $medicine_category->status = '1';
    ...
    {
        foreach ($this->Get_Many_Data($request) as $medicine_category) {
            $medicine_category->status == 1 ? $medicine_category->status = '0' : $medicine_category->status = '1';
            $medicine_category->update();
        }
    }
