...
Route::group(['middleware' => 'admin', 'auth', 'language'], function () {
    Route::prefix('/admin')->group(function () {
        ...
        Route::prefix('/doctor')->group(function () {
            ...
            Route::get('/index_request', [App\Http\Controllers\Acl\DoctorController::class, 'index_request']);
            ...
            Route::get('/change_status_request/{id}', [App\Http\Controllers\Acl\DoctorController::class, 'change_status_request']);
        });
